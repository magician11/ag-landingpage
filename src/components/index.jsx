    ...
    if(this.state.loading === true) {
      ...
      content = (
        <div className="text-center">
          ...
          <h2>web developer & counsellor</h2>
          <br/ >
            ...
            <Row>
              <Col xs={12} sm={6}>
                Designed and built by Andrew Golightly
              </Col>
              <Col xs={12} sm={6}>
                <ul className="list-inline">
                  <li><a href="https://twitter.com/AndrewGolightly"><i className="fa fa-twitter fa-2x" aria-hidden="true"></i></a></li>
                  <li><a href="https://www.facebook.com/andrewgolightly11"><i className="fa fa-facebook fa-2x" aria-hidden="true"></i></a></li>
                  <li><a href="https://github.com/magician11/"><i className="fa fa-github fa-2x" aria-hidden="true"></i></a></li>
                </ul>
              </Col>
            </Row>
          </div>
